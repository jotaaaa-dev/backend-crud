...
const validaCategoria = [
    ...
    check('data','É necessário colocar uma data').not().isEmpty(),
    check('genero','Genero não pode ser vazio').not().isEmpty(),
    check('plataforma','Plataforma é obrigatório').not().isEmpty(),
    check('tamanho','Tamanho não pode ser vazio').not().isEmpty(),
    check('dev','É necessário colocar um desenvolvedor').not().isEmpty(),
